...
Usage:
    python Code_review_full.py --git-dir=<path_to_git_dir> --work-tree=<path_to_work_tree>

Example:
    python Code_review_full.py --git-dir="C:/src/project/.git" --work-tree="C:/src/project"
...
def get_git_diff(git_dir: str, work_tree: str, branch: str = "main") -> str:
    ...
    try:
        result = subprocess.run(
            ["git", f"--git-dir={git_dir}", f"--work-tree={work_tree}", "diff", branch],
            capture_output=True,
            text=True,
            check=True,
        )
